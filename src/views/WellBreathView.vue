...
const cssBtnWBParam = ref('bg-zinc-400 text-white font-bold lg:w-[200px] lg:text-[18px] lg:h-[55px] sm:text-[14px] sm:w-[200px] sm:h-[22px] rounded-lg');
const cssBtnWBController = ref('bg-zinc-300 text-white font-bold lg:w-[200px] lg:text-[18px] lg:h-[55px] sm:text-[14px] sm:w-[200px] sm:h-[22px] rounded-lg');
...
const haddleSelectPage = (evt) => {
    if (evt === 1) {
        ...
        menuPage.value = 'IAQ'
        cssBtnWBParam.value = "bg-zinc-400 text-white font-bold lg:w-[200px] lg:text-[18px] lg:h-[55px] sm:text-[14px] sm:w-[200px] sm:h-[22px] rounded-lg";
        cssBtnWBController.value = "bg-zinc-300 text-white font-bold lg:w-[200px] lg:text-[18px] lg:h-[55px] sm:text-[14px] sm:w-[200px] sm:h-[22px] rounded-lg";
        ...
        cssBtnWBParam.value = "bg-zinc-300 text-white font-bold lg:w-[200px] lg:text-[18px] lg:h-[55px] sm:text-[14px] sm:w-[200px] sm:h-[22px] rounded-lg";
        cssBtnWBController.value = "bg-zinc-400 text-white font-bold lg:w-[200px] lg:text-[18px] lg:h-[55px] sm:text-[14px] sm:w-[200px] sm:h-[22px] rounded-lg";
                        ...
                        <div class="set-manual-con mt-5">
                            ...
                            <div class="border-[1px]  border-zinc-400 rounded-md">
                                ...
                                <div class="grid grid-cols-2 lg:mt-5">
                                    <div>
                                        <img 
                                        class="sm:mt-4 sm:ml-4 sm:translate-y-3 sm:w-[100px] sm:h-[100px] lg:w-[130px] lg:h-[130px]"  
