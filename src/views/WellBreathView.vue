...
const cssBtnWBParam = ref('bg-zinc-400 text-white font-bold lg:w-[210px] lg:text-[18px] lg:h-[55px] sm:text-[14px] sm:w-[200px] sm:h-[22px] rounded-lg');
const cssBtnWBController = ref('bg-zinc-300 text-white font-bold lg:w-[210px] lg:text-[18px] lg:h-[55px] sm:text-[14px] sm:w-[200px] sm:h-[22px] rounded-lg');
...
const haddleSelectPage = (evt) => {
    if (evt === 1) {
        ...
        menuPage.value = 'IAQ'
        cssBtnWBParam.value = "bg-zinc-400 text-white font-bold lg:w-[210px] lg:text-[18px] lg:h-[55px] sm:text-[14px] sm:w-[200px] sm:h-[22px] rounded-lg";
        cssBtnWBController.value = "bg-zinc-300 text-white font-bold lg:w-[210px] lg:text-[18px] lg:h-[55px] sm:text-[14px] sm:w-[200px] sm:h-[22px] rounded-lg";
        ...
        cssBtnWBParam.value = "bg-zinc-300 text-white font-bold lg:w-[210px] lg:text-[18px] lg:h-[55px] sm:text-[14px] sm:w-[200px] sm:h-[22px] rounded-lg";
        cssBtnWBController.value = "bg-zinc-400 text-white font-bold lg:w-[210px] lg:text-[18px] lg:h-[55px] sm:text-[14px] sm:w-[200px] sm:h-[22px] rounded-lg";
                ...
                <div 
                    ...
                    <div class="mt-[30px]" v-if="menuPage === 'Control panel'">
                        <div class="set-manual-con mt-5">
                            <!-- maintaince -->
                            <div 
                            class="border-[1px] border-zinc-400 rounded-md lg:h-[400px] lg:ml-6 lg:w-[160px] sm:h-[210px] sm:w-[150px]">
                            ...
                            <div class="border-[1px]  border-zinc-400 rounded-md">
                                ...
                                <div class="grid grid-cols-2 lg:mt-5">
                                    <div>
                                        <img 
                                        class="sm:mt-4 sm:ml-4 sm:translate-y-3 sm:w-[105px] sm:h-[105px] lg:w-[134px] lg:h-[134px]"  
